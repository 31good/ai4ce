...
class PointAccumulation:
    ...
    def __init__(self, root_dir, output_dir, sequence_, first_frame, last_frame, travel_padding, source_, min_dist_dense=0.02, verbose_=1, compute_labels = False):
        ...
        self.outputPathLabel = self.outputDir+"/labels"
        #self.outputPathLabel = "%s/%s/label" % (self.outputDir, self.sequenceName)
        ...
        self.output_file_pose = "%s/lidar_pose.txt" % self.outputPath


        self.mydict={0:0,6:49,7:40,8:48,9:44,10:16,11:50,12:52,13:51,14:52,15:52,16:52,17:80,18:80, 19:81,20:81,21:70,22:72,
